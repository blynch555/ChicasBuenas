...
@section('headers')
<h2 class="sr-only">Fantasías en {{ Session::get('city_name') }}</h2>
@stop
@section('content')
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-primary panelEscorts">
				<div class="panel-heading">
					<i class="ion-happy-outline"></i> Fantasías
					<span class="pull-right hidden-xs"><i class="ion-information-circled"></i> Servicios especiales como parejas, disfraces, etc.</span>
				</div>
