...
@section('headers')
<h2 class="sr-only">Escorts Premium en {{ Session::get('city_name') }}</h2>
@stop
@section('content')
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-primary panelEscorts">
				<div class="panel-heading">
					...
					<span class="pull-right hidden-xs"><i class="ion-information-circled"></i> Chicas de entre $ 45.000 y $ 70.000</span>
				</div>
